(function () {
  ...
  global.VEL.Skynet.Application = global.VEL.Skynet.Application || {};
  global.VEL.Skynet.Application.Client =
    global.VEL.Skynet.Application.Client || {};
  global.VEL.Skynet.Application.Client.Documents =
    global.VEL.Skynet.Application.Client.Documents || {};
  global.VEL.Skynet.Application.Client.GoogleClassroom =
    global.VEL.Skynet.Application.Client.GoogleClassroom || {};
  ss.initAssembly(k, "VEL.Skynet.Application.Client");
  var l = function () {
    this.$5 = 0;
    this.$6 = false;
  ...
  l.__typeName = "VEL.Skynet.Application.Client.$0";
  var m = function () {
    this.$1$1 = null;
    this.$1$2 = null;
    this.$1$3 = 0;
  ...
  m.__typeName = "VEL.Skynet.Application.Client.$1";
  var n = function () {
    this.$z = null;
    this.$q = null;
    this.$s = null;
    ...
    this.$p = null;
    this.$t = null;
    VEL.Skynet.Core.Application.App.call(this);
    VEL.Skynet.Global.Modules.app = this;
    this.$r = ServerModel.fontStackId;
    this.$s = new l();
    this.$q = new p(this);
    this.$z = new q();
    this.$v = new VEL.Skynet.Global.Controls.Control.$ctor1(
      ".js-play-preload"
    );
    this.$A = VEL.Skynet.Global.Helpers.SettingsHelper.get$2(
      "session_id",
      null
    );
    if (ss.isNullOrUndefined(this.$A)) {
      this.$A = ss.getHashCode(this).toString();
      VEL.Skynet.Global.Helpers.SettingsHelper.set(
        "session_id",
        this.$A,
        true
      );
    ...
    if (!(ServerModel.templateId === undefined)) {
      var a = VEL.Skynet.Core.Application.TemplateManager.getTemplate(
  ...
  n.__typeName = "VEL.Skynet.Application.Client.ClientApp";
  n.$0 = function () {
  ...
  global.VEL.Skynet.Application.Client.ClientApp = n;
  var o = function () {};
  o.__typeName = "VEL.Skynet.Application.Client.FullscreenSeleniumHook";
  global.VEL.Skynet.Application.Client.FullscreenSeleniumHook = o;
  var p = function (a) {
    this.$c = false;
    this.$a = 20;
    this.$b = false;
  ...
  p.__typeName = "VEL.Skynet.Application.Client.Documents.DocumentStore";
  global.VEL.Skynet.Application.Client.Documents.DocumentStore = p;
  var q = function () {};
  q.__typeName = "VEL.Skynet.Application.Client.Documents.ResultsStore";
  global.VEL.Skynet.Application.Client.Documents.ResultsStore = q;
  ...
  r.__typeName = "VEL.Skynet.Application.Client.GoogleClassroom.$0";
  r.$0 = function (a, b, c) {
  ...
  s.__typeName =
    "VEL.Skynet.Application.Client.GoogleClassroom.GoogleClassroomApplicationAssignment";
  s.$0 = function (a) {
    return (a & 4) !== 0;
  };
  global.VEL.Skynet.Application.Client.GoogleClassroom.GoogleClassroomApplicationAssignment =
    s;
  var t = function (a, b) {
    this.$2 = null;
    this.$1$1 = null;
  ...
  t.__typeName =
    "VEL.Skynet.Application.Client.GoogleClassroom.GoogleClassroomUserAssignmentData";
  global.VEL.Skynet.Application.Client.GoogleClassroom.GoogleClassroomUserAssignmentData =
    t;
  ss.initClass(l, k, {
    $3: function (a) {
      if (
  ...
  ss.initClass(
    ...
    k,
    {
      ...
      setThemeId: function (a, b) {
        ...
        this.$C.selected =
          VEL.Skynet.Core.View.Themes.ThemeHelper.getTheme(a);
        if (b) {
          this.destroyView();
          this.$k();
        }
      ...
      onStartComplete: function () {
        ...
        // Indica se o backend está disponível
var backendAvailable = false; // false = evita requisição e 404

if (!backendAvailable) {
    console.log("Backend indisponível. Ignorando trackplay.");
    // opcional: você pode salvar localmente ou apenas ignorar
} else {
    var c = "/resourceajax/trackplay?activityId=" + ServerModel.activityId +
            "&templateId=" + this.get_document().get_template().get_id() +
            "&themeId=" + this.$C.selected.id +
            "&firstConvert=" + b;
    ...
    $.ajax({
        ...
        success: function(response) {
            console.log("Trackplay registrado com sucesso");
        },
        error: function() {
            console.log("Falha ao registrar trackplay, mas não quebra a aplicação");
        }
    });
}
      ...
      onGetTestCard: function () {
        var a = new VEL.Skynet.Core.Application.TestCardSetting();
      ...
      onSetAudioSetting: function (a, b) {
        var c = ss.Enum.getName(
          VEL.Skynet.Global.Enums.AudioSetting,
          a
        ).toLowerCase();
            ...
            if (a === 0) {
              switch (
                VEL.Skynet.Global.Server.Switches.getInteger(
                  ...
                  VEL.Skynet.Global.Server.SwitchKeys.musicDefaultMuteSetting
                )
              ) {
                case 1:
                  e = false;
        ...
        $.ajax({
          ...
          success: ss.mkdel(this, function (g, h, i) {
            var j = Enumerable.from(
              VEL.Skynet.Core.Toolbox.Serialization.JsonHelper.deserializeEnumerable(
                VEL.Skynet.Global.Json.LeaderboardEntryJson
              ).call(null, ss.cast(g, String))
            ).toArray();
            c(j);
            if (ss.isValue(VEL.Skynet.Global.Modules.activityPage)) {
              VEL.Skynet.Global.Modules.activityPage.updateLeaderboard(
                j,
      ...
      onExitAssignment: function () {
        if (ss.isValue(VEL.Skynet.Global.Modules.playPage)) {
          VEL.Skynet.Global.Modules.playPage.restart();
        }
      },
      setSetting: function (a, b, c) {
        VEL.Skynet.Global.Helpers.SettingsHelper.set(a, b, c);
      },
      getSetting: function (a, b) {
        return VEL.Skynet.Global.Helpers.SettingsHelper.get$2(a, b);
      },
      onActivityContentChanged: function () {
        if (ss.isValue(VEL.Skynet.Global.Modules.activityPage)) {
          VEL.Skynet.Global.Modules.activityPage.onContentChanged();
        }
      },
      restart: function () {
      ...
      destroyView: function () {
        ...
        VEL.Skynet.Core.Application.App.prototype.destroyView.call(this);
      },
      $9: function (a, b, c) {
        var d = c;
        ...
        var e = d;
        var f = VEL.Skynet.Core.Application.TemplateManager.createTemplate(e);
        var g = new VEL.Skynet.View.ClientView(this, false);
        ...
        this.set_activeGame(
          new VEL.Skynet.Core.Games.PreStartGame(g, this, h)
        );
        g.onPreStart(
      ...
      $f: function (a, b) {
        ...
        if (this.$B === 1) {
          VEL.Skynet.Global.Modules.activityPage.onDocumentOpen();
        }
        this.setThemeId(this.$C.selected.id, true);
        if (this.$B === 1) {
          this.$7(9);
          VEL.Skynet.Global.Modules.activityPage.populateOptionsSection();
          VEL.Skynet.Global.Modules.activityPage.populateThemesList();
          VEL.Skynet.Global.Modules.activityPage.populateTemplates();
          VEL.Skynet.Global.Modules.activityPage.populateLeaderboard();
          this.$7(10);
        }
      },
      $k: function () {
        ...
        var a = ss.cast(
          ...
          VEL.Skynet.Core.Application.IGame_Application
        );
        var b = this.$B !== 2;
        var c =
          this.get_document()
            ...
            .get_contentModel()
            .getUnicodeRange() |
          VEL.Skynet.Core.DataStructures.UnicodeRange.getUnicodeRange(
            ServerModel.languageId
          );
        var d = VEL.Skynet.Global.Server.Switches.getThemeAudio(
          VEL.Skynet.Global.Server.Switches.static$1,
          this.$C.selected.id
        );
        VEL.Skynet.View.Assets.AssetLoader.start(
          this.$C.selected,
          this.$r,
          c,
          a.get_template(),
        ...
        this.$y = window.setTimeout(
          ss.mkdel(this, function () {
            ...
            var e =
              VEL.Skynet.View.Assets.AssetLoader.getPreloadStatus() +
              "|" +
              VEL.Skynet.View.Assets.Reusables.ReusableTest.getMemory() +
              "kB|" +
              this.$w;
            VEL.Skynet.Global.LogHelper.event("theme_timeout", e);
            VEL.Skynet.Global.Shell.writeError(e);
          }),
          30000
        );
      },
      $d: function () {
        var a = VEL.Skynet.View.Assets.AssetLoader.getErrors();
        if (ss.isValue(a) && Enumerable.from(a).any()) {
          VEL.Skynet.Global.LogHelper.event("asset_error", a.join("|"));
        }
      },
      $e: function (a, b) {
        if (ss.isValue(VEL.Skynet.Global.Modules.activityPage)) {
          VEL.Skynet.Global.Modules.activityPage.onAssetLoaded(a, b);
        }
        if (ss.isValue(VEL.Skynet.Global.Modules.playPage)) {
          VEL.Skynet.Global.Modules.playPage.onAssetLoaded(a, b);
        }
      },
      $g: function () {
        this.$d();
      ...
      $a: function () {
        this.destroyView();
        this.view = new VEL.Skynet.View.ClientView(this, this.$B === 2);
      },
      $c: function (e, f) {
        this.$C = new VEL.Skynet.Core.View.Themes.ThemeSelection();
        if (this.$B === 5 && f !== 0) {
          this.$C.selected =
            VEL.Skynet.Core.View.Themes.ThemeHelper.getTheme(f);
        ...
        for (var i = 0; i < h.length; i++) {
          var j = h[i];
          var E = VEL.Skynet.Global.Server.Switches.getThemeAction(
            VEL.Skynet.Global.Server.Switches.static$1,
            j.id,
            e
          );
          if (E === 0) {
            E = VEL.Skynet.Global.Server.Switches.getThemeAction(
              VEL.Skynet.Global.Server.Switches.static$1,
              j.id,
              0
            );
        ...
        if (
          ...
          var J =
            Enumerable.from(g).firstOrDefault(function (u) {
              return u.id === f;
            }, ss.getDefaultValue(VEL.Skynet.Core.View.Themes.Theme)) ||
        ...
        for (var a = 0; a < N.length; a++) {
          var b = N[a];
          var c = VEL.Skynet.Global.Server.Switches.getThemeAction(
            VEL.Skynet.Global.Server.Switches.static$1,
            b.id,
            e
          );
          if (c === 0) {
            c = VEL.Skynet.Global.Server.Switches.getThemeAction(
              VEL.Skynet.Global.Server.Switches.static$1,
              b.id,
              0
            );
    ...
    VEL.Skynet.Core.Application.App,
    [
      VEL.Skynet.Core.Application.IApplication,
      VEL.Skynet.Core.Application.IApplication_Game,
      VEL.Skynet.Core.Toolbox.Threading.IThreadScope,
    ]
  );
  ss.initClass(o, k, {});
  ss.initClass(p, k, {
    ...
    restore: function (a) {
      if (ss.referenceEquals(window.localStorage["autosave.guid"], a)) {
        ...
        var c = VEL.Skynet.Global.Helpers.Base64Helper.base64ToDataView(b);
        var d = VEL.Skynet.Core.Application.DocumentFactory.create(c);
        d.set_guid(a);
        return d;
      }
      return null;
    ...
    forceAutoSave: function () {
      this.$9
        .get_document()
        .set_title(
          new VEL.Skynet.Global.Controls.Input.$ctor1(
            ".js-activity-title"
          ).get_value()
        );
    ...
    $1: function (a, b) {
      if (a === "00000000000000000000000000000000") {
        ...
        var d = VEL.Skynet.Global.Helpers.Base64Helper.base64ToDataView(c);
        var e = VEL.Skynet.Core.Application.DocumentFactory.create(d);
        b(e);
        return;
      }
      ...
      d.onload = function (e) {
        if (d.status === 200) {
          ...
          if (ss.isNullOrUndefined(f) || f.length === 0) {
            ...
            var h = VEL.Skynet.Core.Application.DocumentFactory.create(g);
            b(h);
          }
        } else {
          c();
    ...
    $8: function (a, b, c, d, e, f) {
      ...
      i +=
        "&screenshot=" +
        VEL.Skynet.Global.Helpers.SettingsHelper.get(
          "enable_screenshot",
          true
        );
      i +=
      ...
      x.onreadystatechange = function (u) {
        if (x.readyState === 4) {
          if (x.status === 200) {
            ...
            VEL.Skynet.Global.Helpers.AutoSaveHelper.clear();
...
if (!backendAvailable) {
    console.log("Backend indisponível. Usando fallback local para getOptions.");

    var fallbackXML =
        '<options>' +
            '<option id="1" value="value1"/>' +
            '<option id="2" value="value2"/>' +
        '</options>';

    console.log("Fallback XML:", fallbackXML);

    a.readOptions(fallbackXML);
    d();

    console.log("readOptions com fallback concluído.");
} else {
    console.log("Backend disponível. Fazendo requisição AJAX para getOptions...");

    var h = {
        type: "GET",
        dataType: "text",
        url: "/resourceajax/getoptions?templateId=" + g +
             "&activityId=" + ServerModel.activityId +
             "&startMode=" + c,
        success: function(i, j, v) {
            console.log("AJAX getOptions sucesso.");
            if (ss.isInstanceOfType(i, String)) {
                a.readOptions(i.toString());
                console.log("readOptions com dados do backend concluído.");
            }
            d();
        },
        error: function(i, j, v) {
            console.log("AJAX getOptions falhou. Usando fallback local.");
            ...
            console.log("readOptions com fallback após erro AJAX concluído.");
        }
    };
    ...
    $4: function (a, b) {
      ...
      var d = VEL.Skynet.Global.Helpers.Base64Helper.dataViewToBase64(b);
      var e = a.get_guid();
      ...
      window.localStorage["autosave.time"] =
        VEL.Skynet.Global.Extensions.DateTimeExtensions.toUnix(
          new Date()
        ).toString();
    ...
    onHomeworkSubmission: function (a, b, c) {
      ...
      var e = {
        ...
        success: function (f, g, h) {
          ...
          b(ss.cast(f, VEL.Skynet.Global.Json.HomeworkSubmissionInfo));
        },
        error: function (f, g, h) {
          c();
        },
  ...
  ss.initClass(r, k, {
          ...
          $sm1: for (;;) {
            switch (a) {
              ...
              case 1:
                ...
                if (ss.isNullOrUndefined(d)) {
                  e = new VEL.Skynet.Global.Json.GoogleClassroom.UserState();
                  e.isSignedIn = false;
                  b.setResult(e);
                  return;
                }
    ...
    $3: function (a) {
      var b =
        VEL.Skynet.Global.Helpers.GoogleClassroomHelper.exceptionToError(a);
    ...
    $2: function () {
      if (ss.isNullOrUndefined(this.$a)) {
        this.$a =
          VEL.Skynet.Global.Interop.GoogleClassroomClient.createDoAssignmentClient(
            this.$c,
            this.$b
          );
      }
  ...
  ss.initClass(
    ...
    k,
    {
      ...
      getStudentSubmissionState: function () {
        var a =
          new VEL.Skynet.Core.Application.GoogleClassroomStudentSubmissionState();
                    ...
                    $sm2: for (;;) {
                      switch (a) {
                        ...
                        case 3:
                          a = -1;
                          d.getAwaitedResult();
                          VEL.Skynet.Global.Modules.playPage.onTurnedInGoogleClassroomStudentSubmission();
                          a = -1;
                          break $sm2;
                        default:
                          break $sm2;
    ...
    null,
    [
      VEL.Skynet.Core.Application.IGoogleClassroomApplication,
      VEL.Skynet.Core.Application.IGoogleClassroomApplicationAssignment,
    ]
  );
  ss.initClass(t, k, {
